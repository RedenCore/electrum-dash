    ...
    def checkDevice(self):
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00):
                    raise BaseException("Device not in Reden mode")
                raise e
