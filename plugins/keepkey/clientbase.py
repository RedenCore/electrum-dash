...
from electrum_reden.util import PrintError, UserCancelled
from electrum_reden.keystore import bip39_normalize_passphrase
from electrum_reden.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the Reden coins in the wallet.") % self.device
        else:
