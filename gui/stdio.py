...
from electrum_reden.util import format_satoshis, set_verbosity
from electrum_reden.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-reden create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-reden setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-reden setconfig' to change your settings")
        return True
