...
from electrum_reden.masternode_budget import BudgetProposal, BudgetVote
from electrum_reden.masternode_manager import BUDGET_FEE_CONFIRMATIONS
from electrum_reden.util import block_explorer_URL, print_error, format_satoshis_plain
...
def budget_explorer_url(item_type, identifier):
    ...
    if item_type == 'proposal':
        return 'https://redenwhale.org/p/%s' % identifier
...
class ProposalsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        description = ''.join(['You can create a budget proposal below. ',
                'Proposals require 5 REDEN to create. ',
        ...
        form.addRow(_('Payment Address:'), self.address_edit)
        form.addRow(_('Monthly REDEN Payment:'), self.amount_edit)
