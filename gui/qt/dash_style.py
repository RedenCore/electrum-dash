...
QComboBox::down-arrow {
    border-image: url(':/icons/reden_downArrow.png') 0 0 0 0 stretch stretch;
}
...
QAbstractSpinBox::up-arrow {
    image: url(:/icons/reden_upArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::up-arrow:disabled, QAbstractSpinBox::up-arrow:off {
    image: url(:/icons/reden_upArrow_small_disabled.png);
}

QAbstractSpinBox::down-arrow {
    image: url(:/icons/reden_downArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::down-arrow:disabled, QAbstractSpinBox::down-arrow:off {
    image: url(:/icons/reden_downArrow_small_disabled.png);
}
...
QScrollBar:up-arrow {
    background-image: url(':/icons/reden_upArrow_small.png');
}

QScrollBar:down-arrow {
    background-image: url(':/icons/reden_downArrow_small.png');
}

QScrollBar:left-arrow {
    background-image: url(':/icons/reden_leftArrow_small.png');
}

QScrollBar:right-arrow {
    background-image: url(':/icons/reden_rightArrow_small.png');
}
